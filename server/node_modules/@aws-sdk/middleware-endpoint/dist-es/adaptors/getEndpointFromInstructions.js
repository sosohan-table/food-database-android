...
export var getEndpointFromInstructions = function (commandInput, instructionsSupplier, clientConfig, context) { return __awaiter(void 0, void 0, void 0, function () {
    var endpointParams, instructions, _a, _b, _c, name_1, instruction, _d, _e, _f, e_1_1, endpoint;
    var e_1, _g;
    return __generator(this, function (_h) {
        switch (_h.label) {
            ...
            case 5:
                _e = endpointParams;
                _f = name_1;
                return [4, createConfigProvider(instruction.name, clientConfig)()];
            case 6:
                _e[_f] = _h.sent();
                return [3, 8];
...
var createConfigProvider = function (configKey, config) {
